...
def hill_climbing(initial_tour):
    ...
    while True:
        ...
        temp_best_neighbour = min(current_neighbours, key=tour_distance)
        temp_best_distance = tour_distance(temp_best_neighbour)
        if temp_best_distance < current_distance:
            current_tour = temp_best_neighbour
            current_distance = temp_best_distance
        else:
            break
